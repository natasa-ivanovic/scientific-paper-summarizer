...
encoder_states = [state_h, state_h]
...
model.save(f"headings_seq2seq_2L_model.h5")
model.save(f"headings_seq2seq_2L_model.keras")
...
encoder_model.save(f'headings_seq2seq_2L_encoder.keras')
decoder_model.save(f'headings_seq2seq_2L_decoder.keras')
